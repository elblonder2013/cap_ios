...
@interface HomeInversionistaVC ()<UIScrollViewDelegate>
...
@implementation HomeInversionistaVC
...
- (IBAction)GoToPerfil:(id)sender {
    [self HideMenu];
    PerfilInversionistaVC * vc = [[PerfilInversionistaVC alloc] initWithNibName:@"PerfilInversionistaVC" bundle:nil];
